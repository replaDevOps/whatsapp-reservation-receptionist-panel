...
const WhatsappNodeWithButtons = ({ id, data }) => {
        ...
        <Flex gap={10} align="flex-start">
            ...
            <Flex vertical gap={6}>
                ...
                >
                    <Flex align='center' className='w-100' justify='space-between' gap={5}>
                        <Text className='fs-12'>{data?.langone}</Text>
                ...
                >
                    <Flex align='center' className='w-100' justify='space-between' gap={5}>
                        <Text className='fs-12'>{data?.langtwo}</Text>
                        <img src="/assets/icons/share-fork.webp" width={12} alt="share icon" fetchPriority="high"/>
                    </Flex>
                </Button>
            </Flex>
          ...
          <Flex vertical gap={10} justify="space-between" className="node-actions">
            ...
            <Button
              ...
              onClick={() => data?.setAddTextButton(true)}
            >
...
export {WhatsappNodeWithButtons}